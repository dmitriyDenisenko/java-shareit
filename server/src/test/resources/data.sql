...
INSERT INTO PUBLIC.BOOKINGS(start_time, end_time, item_id, booker_id, status)
VALUES ('2022-10-10T12:15','2022-10-13T12:15', 1, 2, 'APPROVED' );
INSERT INTO PUBLIC.BOOKINGS(start_time, end_time, item_id, booker_id, status)
VALUES ('2023-10-10T12:15','2023-12-17T12:15', 1, 2, 'WAITING' );
INSERT INTO PUBLIC.BOOKINGS(start_time, end_time, item_id, booker_id, status)
VALUES ('2022-10-10T12:15','2023-12-17T12:15', 1, 3, 'APPROVED' );

INSERT INTO PUBLIC.REQUESTS(description, requester_id, created)
VALUES ('itemRequest1', 3, '2022-10-14T12:15');