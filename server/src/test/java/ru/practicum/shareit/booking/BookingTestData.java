...
public class BookingTestData {
    public static final BookingDtoUser bookingDtoToUser1 = BookingDtoUser.builder().id(1L)
            .start(LocalDateTime.parse(LocalDateTime.of(2022, 10,
                    14, 12, 15).format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"))))
            .end(LocalDateTime.parse(LocalDateTime.of(2022, 10,
                    14, 12, 15).format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"))))
            .item(itemDto1).booker(userDto2)
            .status(Status.APPROVED).build();
    public static final BookingDtoUser bookingDtoToUser2 = BookingDtoUser.builder().id(2L)
            .start(LocalDateTime.parse(LocalDateTime.of(2023, 10,
                    14, 12, 15).format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"))))
            .end(LocalDateTime.parse(LocalDateTime.of(2023, 10,
                    14, 12, 15).format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"))))
            .item(itemDto1).booker(userDto2)
            .status(Status.APPROVED).build();
    public static final BookingDtoUser bookingDtoToUserCreated = BookingDtoUser.builder().id(3L)
            .start(LocalDateTime.parse(LocalDateTime.now().plusDays(2)
                    .format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"))))
            .end(LocalDateTime.parse(LocalDateTime.now().plusDays(3)
                    .format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"))))
            .item(itemDto1).booker(userDto2)
    ...
    public static final Booking booking1 = Booking.builder().id(1L)
            .start(LocalDateTime.of(2022, 10, 10, 12, 15))
            .end(LocalDateTime.of(2022, 10, 14, 12, 15))
    ...
    public static final BookingDtoState bookingDtoState1 = BookingDtoState.builder()
            .id(1L).start(LocalDateTime.of(2022, 10, 10, 12, 15))
            .end(LocalDateTime.of(2022, 10, 14, 12, 15))
    ...
    public static final BookingDtoState bookingDtoState2 = BookingDtoState.builder()
            .id(1L).start(LocalDateTime.of(2022, 10, 10, 12, 15))
            .end(LocalDateTime.of(2022, 10, 14, 12, 15))
            .item(itemDto1).booker(userDto2).status(Status.WAITING)
            .states(List.of(State.ALL, State.WAITING, State.FUTURE))
            .build();
    ...
    public static final Booking booking4 = Booking.builder().id(1L)
            .start(LocalDateTime.of(2022, 10, 10, 12, 15))
            .end(LocalDateTime.of(2023, 10, 14, 12, 15))
            .item(item1).booker(user2).status(Status.APPROVED).build();
    ...
    public static final BookingDtoState bookingDtoState5 = BookingDtoState.builder()
            .id(1L).start(LocalDateTime.of(2022, 10, 10, 12, 15))
            .end(LocalDateTime.of(2022, 10, 14, 12, 15))
            .item(itemDto1).booker(userDto2).status(Status.REJECTED).states(List.of(State.ALL, State.REJECTED,
                    State.FUTURE))
            .build();
    ...
    public static final BookingDtoState bookingDtoState6 = BookingDtoState.builder()
            .id(1L).start(LocalDateTime.of(2022, 10, 10, 12, 15))
            .end(LocalDateTime.of(2022, 10, 14, 17, 15))
